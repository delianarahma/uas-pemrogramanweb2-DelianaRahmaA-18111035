                     ...
                     <h2>Pra Magang!</h2>
                       ...
                       <div class="card">
                        <div class="card-body bg-light">
                          <h5> Yuk, daftar Pra Magang!</h5>
                          <p>Silahkan isi data dibawah ini dengan benar!</p>
                          </div>
                          <form action="config/tambah_user.php" action="#" method="POST">
                            <div class="form-group">
                              <label for="nama">Nama</label>
                              <input type="name" id="nama" name="nama" class="form-control" placeholder="Silahkan Masukan Nama" maxlength="20" min="3">
                            </div>

                            <div class="form-group">
                              <label for="npm">Npm</label>
                              <input type="number" id="npm" name="npm" class="form-control" placeholder="Silahkan Masukan Npm" maxlength="10" min="8">
                            </div>

                            <div class="form-group">
                              <label for="kelas">Kelas</label>
                              <input type="input" id="kelas" name="kelas" class="form-control" placeholder="Silahkan Masukkan Kelas" > 
                            </div>

                            <div class="form-group">
                              <label for="email">Email</label>
                              <input type="email" id="email" name="email" class="form-control" placeholder="Silahkan Masukkan Email" > 
                            </div>
